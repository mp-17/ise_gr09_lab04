...
\section{Approccio alla scrittura del Makefile}
	...
	\subsubsection*{Versioni del Makefile}
		...
		Il make file ha un target fittizio ``all" senza ricette e con unica dipendenza: il file eseguibile che si vuole creare, universalDrawer in questo caso.
		...
		\paragraph*{Versione 3}
                ...
                se sì, viene utlizzato come compilatore $(PREFI)X-gcc, in caso contrario gcc. La definizione o meno di PREFIX condiziona il valore della variabile OPZIONE.
